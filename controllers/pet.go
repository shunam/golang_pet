...
// URLMapping ...
func (c *PetController) URLMapping() {
...
// @Param	body		body 	models.Pet	true		"body for Pet content"
// @Success 201 {int} models.Pet
// @Failure 403 body is empty
// @router / [post]
func (c *PetController) Post() {
	var v models.Pet
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if _, err := models.AddPet(&v); err == nil {
...
func (c *PetController) GetAll() {
	...
	l, err := models.GetAllPet(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
